...
std::vector<UserKeys> Users::getKeys(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from user_keys where user_id = $1";
    Result r(nullptr);
    {
...
void Users::getKeys(const DbClientPtr &clientPtr,
                    const std::function<void(std::vector<UserKeys>)> &rcb,
